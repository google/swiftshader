...
DECORATE_OP(T, OpSDotKHR)
DECORATE_OP(T, OpUDotKHR)
DECORATE_OP(T, OpSUDotKHR)
DECORATE_OP(T, OpSDotAccSatKHR)
DECORATE_OP(T, OpUDotAccSatKHR)
DECORATE_OP(T, OpSUDotAccSatKHR)
...
DECORATE_OP(T, OpTraceMotionNV)
DECORATE_OP(T, OpTraceRayMotionNV)
...
DECORATE_OP(T, OpConvertUToImageNV)
DECORATE_OP(T, OpConvertUToSamplerNV)
DECORATE_OP(T, OpConvertImageToUNV)
DECORATE_OP(T, OpConvertSamplerToUNV)
DECORATE_OP(T, OpConvertUToSampledImageNV)
DECORATE_OP(T, OpConvertSampledImageToUNV)
DECORATE_OP(T, OpSamplerImageAddressingModeNV)
...
DECORATE_OP(T, OpAtomicFMinEXT)
DECORATE_OP(T, OpAtomicFMaxEXT)
DECORATE_OP(T, OpAssumeTrueKHR)
DECORATE_OP(T, OpExpectKHR)
...
DECORATE_OP(T, OpArbitraryFloatSinCosPiINTEL)
DECORATE_OP(T, OpArbitraryFloatCastINTEL)
DECORATE_OP(T, OpArbitraryFloatCastFromIntINTEL)
DECORATE_OP(T, OpArbitraryFloatCastToIntINTEL)
DECORATE_OP(T, OpArbitraryFloatAddINTEL)
DECORATE_OP(T, OpArbitraryFloatSubINTEL)
DECORATE_OP(T, OpArbitraryFloatMulINTEL)
DECORATE_OP(T, OpArbitraryFloatDivINTEL)
DECORATE_OP(T, OpArbitraryFloatGTINTEL)
DECORATE_OP(T, OpArbitraryFloatGEINTEL)
DECORATE_OP(T, OpArbitraryFloatLTINTEL)
DECORATE_OP(T, OpArbitraryFloatLEINTEL)
DECORATE_OP(T, OpArbitraryFloatEQINTEL)
DECORATE_OP(T, OpArbitraryFloatRecipINTEL)
DECORATE_OP(T, OpArbitraryFloatRSqrtINTEL)
DECORATE_OP(T, OpArbitraryFloatCbrtINTEL)
DECORATE_OP(T, OpArbitraryFloatHypotINTEL)
DECORATE_OP(T, OpArbitraryFloatSqrtINTEL)
DECORATE_OP(T, OpArbitraryFloatLogINTEL)
DECORATE_OP(T, OpArbitraryFloatLog2INTEL)
DECORATE_OP(T, OpArbitraryFloatLog10INTEL)
DECORATE_OP(T, OpArbitraryFloatLog1pINTEL)
DECORATE_OP(T, OpArbitraryFloatExpINTEL)
DECORATE_OP(T, OpArbitraryFloatExp2INTEL)
DECORATE_OP(T, OpArbitraryFloatExp10INTEL)
DECORATE_OP(T, OpArbitraryFloatExpm1INTEL)
DECORATE_OP(T, OpArbitraryFloatSinINTEL)
DECORATE_OP(T, OpArbitraryFloatCosINTEL)
DECORATE_OP(T, OpArbitraryFloatSinCosINTEL)
DECORATE_OP(T, OpArbitraryFloatSinPiINTEL)
DECORATE_OP(T, OpArbitraryFloatCosPiINTEL)
DECORATE_OP(T, OpArbitraryFloatASinINTEL)
DECORATE_OP(T, OpArbitraryFloatASinPiINTEL)
DECORATE_OP(T, OpArbitraryFloatACosINTEL)
DECORATE_OP(T, OpArbitraryFloatACosPiINTEL)
DECORATE_OP(T, OpArbitraryFloatATanINTEL)
DECORATE_OP(T, OpArbitraryFloatATanPiINTEL)
DECORATE_OP(T, OpArbitraryFloatATan2INTEL)
DECORATE_OP(T, OpArbitraryFloatPowINTEL)
DECORATE_OP(T, OpArbitraryFloatPowRINTEL)
DECORATE_OP(T, OpArbitraryFloatPowNINTEL)
DECORATE_OP(T, OpLoopControlINTEL)
DECORATE_OP(T, OpFixedSqrtINTEL)
DECORATE_OP(T, OpFixedRecipINTEL)
DECORATE_OP(T, OpFixedRsqrtINTEL)
DECORATE_OP(T, OpFixedSinINTEL)
DECORATE_OP(T, OpFixedCosINTEL)
DECORATE_OP(T, OpFixedSinCosINTEL)
DECORATE_OP(T, OpFixedSinPiINTEL)
DECORATE_OP(T, OpFixedCosPiINTEL)
DECORATE_OP(T, OpFixedSinCosPiINTEL)
DECORATE_OP(T, OpFixedLogINTEL)
DECORATE_OP(T, OpFixedExpINTEL)
