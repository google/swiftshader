...
template <> struct hash<VULKAN_HPP_NAMESPACE::AndroidHardwareBufferFormatPropertiesANDROID>
  ...
  #if defined( VK_USE_PLATFORM_ANDROID_KHR )
template <> struct hash<VULKAN_HPP_NAMESPACE::AndroidHardwareBufferFormatResolvePropertiesANDROID>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::AndroidSurfaceCreateInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::BindDescriptorBufferEmbeddedSamplersInfoEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::BindIndexBufferIndirectCommandEXT>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::BufferConstraintsInfoFUCHSIA>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::StridedDeviceAddressNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::BuildPartitionedAccelerationStructureIndirectCommandNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::BuildPartitionedAccelerationStructureIndirectCommandNV const & buildPartitionedAccelerationStructureIndirectCommandNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PartitionedAccelerationStructureInstancesInputNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::BuildPartitionedAccelerationStructureInfoNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureBuildClustersBottomLevelInfoNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureBuildClustersBottomLevelInfoNV const & clusterAccelerationStructureBuildClustersBottomLevelInfoNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureGeometryIndexAndGeometryFlagsNV>
  {
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureBuildTriangleClusterInfoNV const & clusterAccelerationStructureBuildTriangleClusterInfoNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureBuildTriangleClusterTemplateInfoNV const & clusterAccelerationStructureBuildTriangleClusterTemplateInfoNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureClustersBottomLevelInputNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureTriangleClusterInputNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureTriangleClusterInputNV const & clusterAccelerationStructureTriangleClusterInputNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureMoveObjectsInputNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureMoveObjectsInputNV const & clusterAccelerationStructureMoveObjectsInputNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureInstantiateClusterInfoNV const & clusterAccelerationStructureInstantiateClusterInfoNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureMoveObjectsInfoNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::ClusterAccelerationStructureMoveObjectsInfoNV const & clusterAccelerationStructureMoveObjectsInfoNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ComputePipelineIndirectBufferInfoNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::CooperativeMatrixFlexibleDimensionsPropertiesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::CooperativeMatrixFlexibleDimensionsPropertiesNV const & cooperativeMatrixFlexibleDimensionsPropertiesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::CooperativeVectorPropertiesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::CuModuleTexturingModeCreateInfoNVX>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::D3D12FenceSubmitInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DevicePipelineBinaryInternalCacheControlKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceQueueGlobalPriorityCreateInfo>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceQueueShaderCoreControlCreateInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DeviceQueueShaderCoreControlCreateInfoARM const & deviceQueueShaderCoreControlCreateInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::DirectFBSurfaceCreateInfoEXT>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DispatchTileInfoQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DrawIndirectCountIndirectCommandEXT>
  {
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::ExecutionGraphPipelineCreateInfoAMDX>
  {
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::ExecutionGraphPipelineScratchSizeAMDX>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ExportSemaphoreWin32HandleInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ExternalComputeQueueCreateInfoNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ExternalComputeQueueDataParamsNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ExternalComputeQueueDeviceCreateInfoNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::ExternalComputeQueueDeviceCreateInfoNV const & externalComputeQueueDeviceCreateInfoNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ExternalFormatQNX>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ExternalMemoryAcquireUnmodifiedEXT>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::FenceGetWin32HandleInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::GeneratedCommandsMemoryRequirementsInfoEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::HostImageCopyDevicePerformanceQuery>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::IOSSurfaceCreateInfoMVK>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ImageAlignmentControlCreateInfoMESA>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ImportMemoryBufferCollectionFUCHSIA>
  ...
  #if defined( VK_USE_PLATFORM_METAL_EXT )
template <> struct hash<VULKAN_HPP_NAMESPACE::ImportMemoryMetalHandleInfoEXT>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ImportSemaphoreZirconHandleInfoFUCHSIA>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectCommandsExecutionSetTokenEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectCommandsIndexBufferTokenEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectCommandsPushConstantTokenEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectCommandsVertexBufferTokenEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectCommandsLayoutCreateInfoEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectExecutionSetPipelineInfoEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectExecutionSetShaderLayoutInfoEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::IndirectExecutionSetShaderInfoEXT>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::MacOSSurfaceCreateInfoMVK>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryBarrierAccessFlags3KHR>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryGetAndroidHardwareBufferInfoANDROID>
  ...
  #if defined( VK_USE_PLATFORM_METAL_EXT )
template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryGetMetalHandleInfoEXT>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryGetZirconHandleInfoFUCHSIA>
  ...
  #if defined( VK_USE_PLATFORM_METAL_EXT )
template <> struct hash<VULKAN_HPP_NAMESPACE::MemoryMetalHandlePropertiesEXT>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::MetalSurfaceCreateInfoEXT>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PartitionedAccelerationStructureFlagsNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PartitionedAccelerationStructureUpdateInstanceDataNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PartitionedAccelerationStructureUpdateInstanceDataNV const & partitionedAccelerationStructureUpdateInstanceDataNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PartitionedAccelerationStructureWriteInstanceDataNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PartitionedAccelerationStructureWriteInstanceDataNV const & partitionedAccelerationStructureWriteInstanceDataNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PartitionedAccelerationStructureWritePartitionTranslationDataNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PartitionedAccelerationStructureWritePartitionTranslationDataNV const & partitionedAccelerationStructureWritePartitionTranslationDataNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PerTileBeginInfoQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PerTileEndInfoQCOM>
  {
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT const & physicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceClusterAccelerationStructureFeaturesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceClusterAccelerationStructurePropertiesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI const & physicalDeviceClusterCullingShaderVrsFeaturesHUAWEI) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCommandBufferInheritanceFeaturesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceCommandBufferInheritanceFeaturesNV const & physicalDeviceCommandBufferInheritanceFeaturesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceComputeShaderDerivativesFeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceComputeShaderDerivativesFeaturesKHR const & physicalDeviceComputeShaderDerivativesFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceComputeShaderDerivativesPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceComputeShaderDerivativesPropertiesKHR const & physicalDeviceComputeShaderDerivativesPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCooperativeMatrix2FeaturesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCooperativeMatrix2PropertiesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceCooperativeMatrix2PropertiesNV const & physicalDeviceCooperativeMatrix2PropertiesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceCooperativeMatrixFeaturesKHR const & physicalDeviceCooperativeMatrixFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceCooperativeMatrixPropertiesKHR const & physicalDeviceCooperativeMatrixPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCooperativeVectorFeaturesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCooperativeVectorPropertiesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCubicClampFeaturesQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCubicWeightsFeaturesQCOM>
  {
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCudaKernelLaunchFeaturesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceCudaKernelLaunchFeaturesNV const & physicalDeviceCudaKernelLaunchFeaturesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCudaKernelLaunchPropertiesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDepthBiasControlFeaturesEXT>
  {
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDepthClampControlFeaturesEXT const & physicalDeviceDepthClampControlFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDepthClampZeroOneFeaturesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDescriptorPoolOverallocationFeaturesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDescriptorPoolOverallocationFeaturesNV const & physicalDeviceDescriptorPoolOverallocationFeaturesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDeviceGeneratedCommandsComputeFeaturesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDeviceGeneratedCommandsFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDeviceGeneratedCommandsFeaturesEXT const & physicalDeviceDeviceGeneratedCommandsFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDeviceGeneratedCommandsPropertiesEXT>
  {
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDisplacementMicromapFeaturesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDisplacementMicromapFeaturesNV const & physicalDeviceDisplacementMicromapFeaturesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDisplacementMicromapPropertiesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDisplacementMicromapPropertiesNV const & physicalDeviceDisplacementMicromapPropertiesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDynamicRenderingLocalReadFeatures>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT const & physicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceExtendedSparseAddressSpaceFeaturesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceExtendedSparseAddressSpacePropertiesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalComputeQueuePropertiesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalComputeQueuePropertiesNV const & physicalDeviceExternalComputeQueuePropertiesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  #if defined( VK_USE_PLATFORM_ANDROID_KHR )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalFormatResolveFeaturesANDROID>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalFormatResolveFeaturesANDROID const & physicalDeviceExternalFormatResolveFeaturesANDROID) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  #if defined( VK_USE_PLATFORM_ANDROID_KHR )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalFormatResolvePropertiesANDROID>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalFormatResolvePropertiesANDROID const & physicalDeviceExternalFormatResolvePropertiesANDROID) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalMemoryScreenBufferFeaturesQNX>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceFragmentDensityMapOffsetPropertiesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceFragmentDensityMapOffsetPropertiesEXT const & physicalDeviceFragmentDensityMapOffsetPropertiesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceFrameBoundaryFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceFrameBoundaryFeaturesEXT const & physicalDeviceFrameBoundaryFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceGlobalPriorityQueryFeatures>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceHostImageCopyFeatures>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceHostImageCopyProperties>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceImageAlignmentControlFeaturesMESA>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceImageAlignmentControlPropertiesMESA>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceImageAlignmentControlPropertiesMESA const & physicalDeviceImageAlignmentControlPropertiesMESA) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceImageProcessing2FeaturesQCOM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceImageProcessing2FeaturesQCOM const & physicalDeviceImageProcessing2FeaturesQCOM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceImageProcessing2PropertiesQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceImageSlicedViewOf3DFeaturesEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceIndexTypeUint8Features>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLayeredApiPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceLayeredApiPropertiesKHR const & physicalDeviceLayeredApiPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLayeredApiPropertiesListKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLayeredApiVulkanPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceLayeredApiVulkanPropertiesKHR const & physicalDeviceLayeredApiVulkanPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLayeredDriverPropertiesMSFT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLegacyVertexAttributesFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceLegacyVertexAttributesFeaturesEXT const & physicalDeviceLegacyVertexAttributesFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLegacyVertexAttributesPropertiesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceLegacyVertexAttributesPropertiesEXT const & physicalDeviceLegacyVertexAttributesPropertiesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLineRasterizationFeatures>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLineRasterizationProperties>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceLineRasterizationProperties const & physicalDeviceLineRasterizationProperties) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance5Features>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance5Properties>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance6Features>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance6Properties>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance7FeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance7FeaturesKHR const & physicalDeviceMaintenance7FeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance7PropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance7PropertiesKHR const & physicalDeviceMaintenance7PropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance8FeaturesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMapMemoryPlacedPropertiesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceMapMemoryPlacedPropertiesEXT const & physicalDeviceMapMemoryPlacedPropertiesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM const & physicalDeviceMultiviewPerViewRenderAreasFeaturesQCOM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceNestedCommandBufferFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceNestedCommandBufferFeaturesEXT const & physicalDeviceNestedCommandBufferFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceNestedCommandBufferPropertiesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceNestedCommandBufferPropertiesEXT const & physicalDeviceNestedCommandBufferPropertiesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePartitionedAccelerationStructureFeaturesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDevicePartitionedAccelerationStructureFeaturesNV const & physicalDevicePartitionedAccelerationStructureFeaturesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePartitionedAccelerationStructurePropertiesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDevicePartitionedAccelerationStructurePropertiesNV const & physicalDevicePartitionedAccelerationStructurePropertiesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePerStageDescriptorSetFeaturesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineBinaryFeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineBinaryFeaturesKHR const & physicalDevicePipelineBinaryFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineBinaryPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineBinaryPropertiesKHR const & physicalDevicePipelineBinaryPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT const & physicalDevicePipelineLibraryGroupHandlesFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineOpacityMicromapFeaturesARM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineProtectedAccessFeatures>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineRobustnessFeatures>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePipelineRobustnessProperties>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePortabilitySubsetPropertiesKHR>
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePresentMeteringFeaturesNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePresentModeFifoLatestReadyFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDevicePresentModeFifoLatestReadyFeaturesEXT const & physicalDevicePresentModeFifoLatestReadyFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePushDescriptorProperties>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDevicePushDescriptorProperties const & physicalDevicePushDescriptorProperties) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceRawAccessChainsFeaturesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceRawAccessChainsFeaturesNV const & physicalDeviceRawAccessChainsFeaturesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceRayTracingLinearSweptSpheresFeaturesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceRayTracingLinearSweptSpheresFeaturesNV const & physicalDeviceRayTracingLinearSweptSpheresFeaturesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceRayTracingPositionFetchFeaturesKHR const & physicalDeviceRayTracingPositionFetchFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceRelaxedLineRasterizationFeaturesIMG>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceRelaxedLineRasterizationFeaturesIMG const & physicalDeviceRelaxedLineRasterizationFeaturesIMG) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceRenderPassStripedFeaturesARM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceRenderPassStripedPropertiesARM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceSchedulingControlsFeaturesARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceSchedulingControlsFeaturesARM const & physicalDeviceSchedulingControlsFeaturesARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceSchedulingControlsPropertiesARM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderAtomicFloat16VectorFeaturesNV>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderAtomicFloat16VectorFeaturesNV const & physicalDeviceShaderAtomicFloat16VectorFeaturesNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderBfloat16FeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderBfloat16FeaturesKHR const & physicalDeviceShaderBfloat16FeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderCorePropertiesARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderCorePropertiesARM const & physicalDeviceShaderCorePropertiesARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderEnqueueFeaturesAMDX>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderEnqueueFeaturesAMDX const & physicalDeviceShaderEnqueueFeaturesAMDX) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderEnqueuePropertiesAMDX>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderEnqueuePropertiesAMDX const & physicalDeviceShaderEnqueuePropertiesAMDX) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderExpectAssumeFeatures>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderMaximalReconvergenceFeaturesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderObjectFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderObjectFeaturesEXT const & physicalDeviceShaderObjectFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderObjectPropertiesEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderQuadControlFeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderQuadControlFeaturesKHR const & physicalDeviceShaderQuadControlFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR const & physicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderReplicatedCompositesFeaturesEXT const & physicalDeviceShaderReplicatedCompositesFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderSubgroupRotateFeatures>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderTileImageFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderTileImageFeaturesEXT const & physicalDeviceShaderTileImageFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderTileImagePropertiesEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceTileMemoryHeapFeaturesQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceTileMemoryHeapPropertiesQCOM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceTileMemoryHeapPropertiesQCOM const & physicalDeviceTileMemoryHeapPropertiesQCOM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceTileShadingFeaturesQCOM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceTileShadingFeaturesQCOM const & physicalDeviceTileShadingFeaturesQCOM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceTileShadingPropertiesQCOM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceTileShadingPropertiesQCOM const & physicalDeviceTileShadingPropertiesQCOM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorFeatures>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorFeatures const & physicalDeviceVertexAttributeDivisorFeatures) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorProperties>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorProperties const & physicalDeviceVertexAttributeDivisorProperties) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeRobustnessFeaturesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeRobustnessFeaturesEXT const & physicalDeviceVertexAttributeRobustnessFeaturesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVideoEncodeQualityLevelInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceVideoEncodeQualityLevelInfoKHR const & physicalDeviceVideoEncodeQualityLevelInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR const & physicalDeviceVideoEncodeQuantizationMapFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceVideoMaintenance2FeaturesKHR const & physicalDeviceVideoMaintenance2FeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceYcbcrDegammaFeaturesQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceZeroInitializeDeviceMemoryFeaturesEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineIndirectDeviceAddressInfoNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineRasterizationLineStateCreateInfo>
  {
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineShaderStageNodeCreateInfoAMDX>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PipelineShaderStageNodeCreateInfoAMDX const & pipelineShaderStageNodeCreateInfoAMDX) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VertexInputBindingDivisorDescription>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineVertexInputDivisorStateCreateInfo>
  {
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PipelineViewportDepthClampControlCreateInfoEXT const & pipelineViewportDepthClampControlCreateInfoEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PresentFrameTokenGGP>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PushDescriptorSetWithTemplateInfo>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::QueryPoolVideoEncodeFeedbackCreateInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::QueryPoolVideoEncodeFeedbackCreateInfoKHR const & queryPoolVideoEncodeFeedbackCreateInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::QueueFamilyGlobalPriorityProperties>
  {
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::RayTracingPipelineClusterAccelerationStructureCreateInfoNV const & rayTracingPipelineClusterAccelerationStructureCreateInfoNV) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::ReleaseCapturedPipelineDataInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::RenderPassFragmentDensityMapOffsetEndInfoEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::RenderPassTileShadingCreateInfoQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::RenderingEndInfoEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::RenderingInputAttachmentIndexInfo>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::SamplerBlockMatchWindowCreateInfoQCOM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::SamplerBlockMatchWindowCreateInfoQCOM const & samplerBlockMatchWindowCreateInfoQCOM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::SamplerCubicWeightsCreateInfoQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::SamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::SamplerYcbcrConversionYcbcrDegammaCreateInfoQCOM const & samplerYcbcrConversionYcbcrDegammaCreateInfoQCOM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::SemaphoreGetZirconHandleInfoFUCHSIA>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::SetDescriptorBufferOffsetsInfoEXT>
  {
  ...
  #if defined( VK_ENABLE_BETA_EXTENSIONS )
template <> struct hash<VULKAN_HPP_NAMESPACE::SetPresentConfigNV>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::SurfaceFullScreenExclusiveWin32InfoEXT>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::TileMemoryBindInfoQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::TileMemoryRequirementsQCOM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::TileMemorySizeInfoQCOM>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ViSurfaceCreateInfoNN>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoDecodeAV1SessionParametersCreateInfoKHR>
  {
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoDecodeH264InlineSessionParametersInfoKHR const & videoDecodeH264InlineSessionParametersInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1GopRemainingFrameInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeAV1GopRemainingFrameInfoKHR const & videoEncodeAV1GopRemainingFrameInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1QualityLevelPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeAV1QualityLevelPropertiesKHR const & videoEncodeAV1QualityLevelPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1QuantizationMapCapabilitiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeAV1QuantizationMapCapabilitiesKHR const & videoEncodeAV1QuantizationMapCapabilitiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1SessionCreateInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeAV1SessionParametersCreateInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeAV1SessionParametersCreateInfoKHR const & videoEncodeAV1SessionParametersCreateInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264GopRemainingFrameInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264QualityLevelPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH264QualityLevelPropertiesKHR const & videoEncodeH264QualityLevelPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264QuantizationMapCapabilitiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH264QuantizationMapCapabilitiesKHR const & videoEncodeH264QuantizationMapCapabilitiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264RateControlInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264RateControlLayerInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH264RateControlLayerInfoKHR const & videoEncodeH264RateControlLayerInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionCreateInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionParametersAddInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionParametersAddInfoKHR const & videoEncodeH264SessionParametersAddInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionParametersCreateInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionParametersFeedbackInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionParametersFeedbackInfoKHR const & videoEncodeH264SessionParametersFeedbackInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionParametersGetInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH264SessionParametersGetInfoKHR const & videoEncodeH264SessionParametersGetInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265GopRemainingFrameInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH265GopRemainingFrameInfoKHR const & videoEncodeH265GopRemainingFrameInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265NaluSliceSegmentInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH265NaluSliceSegmentInfoKHR const & videoEncodeH265NaluSliceSegmentInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265QualityLevelPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH265QualityLevelPropertiesKHR const & videoEncodeH265QualityLevelPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265QuantizationMapCapabilitiesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265RateControlInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265RateControlLayerInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionCreateInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersAddInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersAddInfoKHR const & videoEncodeH265SessionParametersAddInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersCreateInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersFeedbackInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersFeedbackInfoKHR const & videoEncodeH265SessionParametersFeedbackInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersGetInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeH265SessionParametersGetInfoKHR const & videoEncodeH265SessionParametersGetInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeQualityLevelPropertiesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeQuantizationMapCapabilitiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeQuantizationMapCapabilitiesKHR const & videoEncodeQuantizationMapCapabilitiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeQuantizationMapInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeQuantizationMapSessionParametersCreateInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeQuantizationMapSessionParametersCreateInfoKHR const & videoEncodeQuantizationMapSessionParametersCreateInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeSessionParametersFeedbackInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoEncodeSessionParametersGetInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoEncodeSessionParametersGetInfoKHR const & videoEncodeSessionParametersGetInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoFormatAV1QuantizationMapPropertiesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoFormatH265QuantizationMapPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoFormatH265QuantizationMapPropertiesKHR const & videoFormatH265QuantizationMapPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VideoFormatQuantizationMapPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::VideoFormatQuantizationMapPropertiesKHR const & videoFormatQuantizationMapPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::Win32SurfaceCreateInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::WriteDescriptorSetPartitionedAccelerationStructureNV>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::WriteIndirectExecutionSetShaderEXT>
  {
